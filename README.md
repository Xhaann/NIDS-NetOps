...
[Directional IP hop-limit statistics](src/analysis/README.md#ip-hop-limit-statistics) aggregate decoded IPv4 TTL and IPv6 Hop Limit values in existing TCP/UDP flow windows. Immutable sparse distributions expose counts, extrema and exact means with at most 256 bins per direction, retaining no packets or payloads. These measurements describe observed lifetime fields without inferring route lengths or attacks.
