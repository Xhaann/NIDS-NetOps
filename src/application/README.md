...
Configuration management here means representation and validation only. Loading, environment/CLI configuration, discovery, registries, merging, persistence, result storage, and reporting are not implemented. Detector Versioning is reserved for Commit #38; Feature Contract Versioning is reserved for Commit #39. This representation preserves existing detector version strings and introduces neither future subsystem nor a feature-contract version.
