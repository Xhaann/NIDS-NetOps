...
class FlowObservationWindow:
    ...
    @property
    def tcp_option_statistics(self) -> DirectionalTCPOptionStatistics:
        return self.coordinated_state.tcp_option_statistics

    @property
    def ip_hop_limit_statistics(self) -> DirectionalIPHopLimitStatistics:
        return self.coordinated_state.ip_hop_limit_statistics
